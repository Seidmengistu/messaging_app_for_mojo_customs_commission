                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                           ...
                                           // die();                                                                                                                                                       
                                            ...
                                            $sql = "SELECT * from complain  WHERE Recipant_Name=:app ";
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content bg-info">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Seen Warning
                                            </h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="../include/seecomplaint.inc.php" method="GET">
