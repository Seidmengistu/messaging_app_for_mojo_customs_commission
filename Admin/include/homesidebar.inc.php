                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../admin/managemessages/SeeMessages.php" class="nav-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="../admin/managemessages/ShowStatistics.php" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../admin/manageusers/ApproveProblemSolvers.php" class="nav-link">
                                            <i class="far fa-circle text-info"></i>
                                            <p>Approve Problem Solvers</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="../admin/manageusers/ApproveUsers.php" class="nav-link">
                                            <i class="far fa-circle text-warning"></i>
                                            <p>Approve Users</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="../admin/manageusers/ShowStatistics.php" class="nav-link">
                                            <i class="far fa-circle text-danger"></i>
                                            <p>Show Statistics</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="../Admin/complaint/SeeComplaint.php" class="nav-link">
                                            <i class="far fa-circle text-warning"></i>
                                            <p>See Complaint</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="../Admin/complaint/ShowStatistics.php" class="nav-link">
                                            <i class="far fa-circle text-danger"></i>
                                            <p>Show Statistics</p>
                                        </a>
                                    </li>
