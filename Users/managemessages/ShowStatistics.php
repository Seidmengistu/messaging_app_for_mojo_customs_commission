                                        ...
                                        <div class="col-lg-3 col-6">
                                            <div style="text-align:center" class="small-box bg-info">
                                                ...
                                                <?php
                                                    ...
                                                    $query=$dbh->prepare("SELECT id From message WHERE Status_1=1 &&  Fromm=:app ORDER BY id");
                                            ...
                                            <div style="text-align:center" class="small-box bg-info">
                                                <div class="inner">
                                                            <?php
                                                                    ...
                                                                    $query=$dbh->prepare("SELECT id From message WHERE Status_2=1 &&  Fromm=:app ORDER BY id");
                                                                    $query->bindparam(':app',$app,PDO::PARAM_STR);
                                                                    $query->execute();
                                                                    $row=$query->rowCount();
                                                                    echo '<h1>'.$row.'</h1>';
                                            ...
                                            <div class="small-box bg-warning">
                                                <div class="inner">
                                                                <?php
                                                                    ...
                                                                    $query=$dbh->prepare("SELECT id From message WHERE Status_2=0 &&  Fromm=:app ORDER BY id");
                                                                    $query->bindparam(':app',$app,PDO::PARAM_STR);
                                                                    $query->execute();
                                                                    $row=$query->rowCount();
                                                                    echo '<h1>'.$row.'</h1>';
