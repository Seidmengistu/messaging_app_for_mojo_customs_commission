        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <span class="badge badge-danger navbar-badge"></span>
            ...
            <ul class="nav nav-treeview"> 
              <li class="nav-item">
                <a href="../manage users/ApproveUsers.php" class="nav-link">
                  <i class="far fa-circle text-danger"></i>
                  <p>Approve Users</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../manage users/UShowStatistics.php" class="nav-link">
          ...
          <i class="nav-icon far fa-envelope"></i>
              ...
              <p>
                    ...
                    {  
                     ...
                     $query=$dbh->prepare("SELECT id From message WHERE  Status_1=0 && Solver=:app && Status_3=1  ORDER BY id");
                     $query-> bindParam(':app', $app, PDO::PARAM_STR);
                     $query->execute(); 
                     $row=$query->rowCount();
                      ?>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../managemessages/ShowMessageAdmin.php" class="nav-link">
                  <i class="far fa-circle text-warning"></i>
