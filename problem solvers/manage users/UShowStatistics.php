                            ...
                            <div class="content">
                                ...
                                <div class="container-fluid">
                                        ...
                                        <div class="col-lg-3 col-6">
                                            <div style="align:center" class="small-box bg-info">
                                                ...
                                                {  
                                                    ...
                                                    $query=$dbh->prepare("SELECT id From users WHERE Status=1 && Role='Users' && Aprovement_To=:app ORDER BY id");
                                    ...
                                    {  
                                        ...
                                        $query=$dbh->prepare("SELECT id From users WHERE Status=0 && Role='Users' && Aprovement_To=:app ORDER BY id");
                                        $query->bindparam(':app',$app,PDO::PARAM_STR);
                                         $query->execute();
                                        $row=$query->rowCount();
                                        echo '<h1>'.$row.'</h1>';
